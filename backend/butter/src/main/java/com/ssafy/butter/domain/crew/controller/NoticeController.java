...
public class NoticeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateCrewNotice(@CurrentUser AuthInfoDTO currentUser, @PathVariable Long id, @ModelAttribute NoticeSaveRequestDTO noticeSaveRequestDTO) {
