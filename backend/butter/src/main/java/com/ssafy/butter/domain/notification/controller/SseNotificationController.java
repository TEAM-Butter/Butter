...
import com.ssafy.butter.domain.notification.service.SseNotificationService;
...
public class SseNotificationController {
    ...
    public ResponseEntity<SseEmitter> subscribe(
        ...
        SseEmitter sseEmitter = sseNotificationService.subscribe(authInfoDTO.id(), lastEventId);
